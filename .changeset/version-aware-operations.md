...
- **Built-in names are reserved.** Registering an operation named `undo`, `redo`, `pageMutations`, or `pageEntities` throws `ReservedOperationNameError` instead of silently shadowing the built-in. New export: `ReservedOperationNameError`.
