...
/**
 * Thrown when a ref used as a changeSetRef resolves to an entity kind that is
 * not declared as a changeSet (`changeSet: true`). Catches e.g. passing a
 * `Post` ref where a `Draft` (changeSet) ref was expected.
 */
